...
## Kısa not:
[Ornek_Cıktılar](./Ornek_Cıktılar/) klasöründen örnek çıktılara bakabilirsiniz.  
Sistemi test etmek için [sample_input_data_for_report_generation](./sample_input_data_for_report_generation/) klasöründeki verileri kullanabilirsiniz.
